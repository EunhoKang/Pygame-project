...
def runGame():
    ...
    global none
    global chat_q1, chat_q2, chat_q3, chat_qg, chat_a1, chat_a2, chat_a3, chat_ag,warn,new
    global pycharm, pycharm_but
    global pycharm_code,pycharm_code2,pycharm_code3,pycharm_prob,seat
    global die,die2
    global glitch_sound, footstep_sound, typing_sound,Gotcha,horray
    global timeover,submit,askquit,askgiveup,caution
    """
    ...
    wifi_time= random.randrange(61,90)
        ...
        for x in imp_range:
            ...
            if x.ID==1:
                if window_type1==1 :
                    ...
                    gamepad.blit(pycharm_prob[1],(x.locate[0],x.locate[1]+x.bar[2]))
            if x.ID==2 :
                ...
                if 10<=percent<20:
                    gamepad.blit(pycharm_code2[0],(x.locate[0]+180+64,x.locate[1]+46))
                elif 20<=percent<30:
                    gamepad.blit(pycharm_code2[1],(x.locate[0]+180+64,x.locate[1]+46))
                elif 30<=percent<40:
                    gamepad.blit(pycharm_code2[2],(x.locate[0]+180+64,x.locate[1]+46))
                elif 40<=percent<50:
                    gamepad.blit(pycharm_code2[3],(x.locate[0]+180+64,x.locate[1]+46))
                elif 50<=percent<60:
                    gamepad.blit(pycharm_code2[4],(x.locate[0]+180+64,x.locate[1]+46))
                if 60<=percent<70:
                    gamepad.blit(pycharm_code2[5],(x.locate[0]+180+64,x.locate[1]+46))
                elif 70<=percent<80:
                    gamepad.blit(pycharm_code2[6],(x.locate[0]+180+64,x.locate[1]+46))
                elif 80<=percent<90:
                    gamepad.blit(pycharm_code2[7],(x.locate[0]+180+64,x.locate[1]+46))
                elif 90<=percent<100:
                    gamepad.blit(pycharm_code2[8],(x.locate[0]+180+64,x.locate[1]+46))
                elif 100<=percent:
                    gamepad.blit(pycharm_code2[9],(x.locate[0]+180+64,x.locate[1]+46))
            ...
            if x.ID==3 :
                ...
                if wait==2:
                    if msg == 1:
                        if drawob.ID == 22:
                            if f_time>t:
                                if f_time - 10 <= t <= f_time:
                                    bool = 0
                                    sorry2 = False
                                else:
                                    bool = 4
                                    sorry2=True
                            elif s_time> t > f_time:
                                if s_time - 10 <= t <= s_time :
                                    bool = 0
                                    sorry2 = False
                                else:
                                    bool = 4
                                    sorry2 = True
                            elif t_time > t > s_time:
                                if t_time - 10 <= t <= t_time:
                                    bool = 0
                                    sorry2 = False
                                else:
                                    bool = 4
                                    sorry2 = True
                            elif fo_time > t >t_time:
                                if fo_time - 10 <= t <= fo_time:
                                    bool = 0
                                    sorry2 = False
                                else:
                                    bool = 4
                    ...
                    if drawob.ID==25 and drawchat:
                        if deathcount>0:
                            for g in range(deathcount):
                                gamepad.blit(warn,(x.locate[0]-280+3,x.locate[1]+3+64+35*g))
...
def initGame():
    ...
    pygame.display.set_caption('2주차 실습')#제목 설정
    ...
    caution=pygame.image.load("image/caution.png")
    """
    런게임 실행
    """
