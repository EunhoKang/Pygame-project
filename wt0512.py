...
def runGame():
    ...
    객체 생성
    """
    window1 = window_model((windows[0], 400, 200), (bars[0], 400, 30), (buttons[0], 30, 30), window1_loc,1)
    window2 = window_model((windows[1], 400, 200), (bars[1], 400, 30), (buttons[1], 30, 30),
                           (window1_loc[0] + 100, window1_loc[1] + 100),2)
    window3 = window_model((windows[2], 400, 200), (bars[2], 400, 30), (buttons[2], 30, 30),
