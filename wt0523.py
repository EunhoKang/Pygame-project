...
def runGame():
    ...
    def menu_func(draw, mouse_x, mouse_y):
        if event.type == MOUSEBUTTONDOWN and event.button == 1:
            if 0 <= mouse_x <= 40 and padHeight-40 <= mouse_y <= padHeight:
                draw = True
            elif not (0 <= mouse_x <= 40 and padHeight-40 <= mouse_y <= padHeight) and not (0<= mouse_x<=246 and padHeight-40-162 <= mouse_y <= padHeight-40) :
                draw= False
        if draw:
    ...
    def wifi_func(draw, mouse_x, mouse_y):
        if event.type == MOUSEBUTTONDOWN and event.button == 1:
            if 1080 <= mouse_x <= 1080+40 and padHeight-40 <= mouse_y <= padHeight:
                draw = True
            elif not (1080 <= mouse_x <= 1080+40 and padHeight-40 <= mouse_y <= padHeight) and not (1080+40-256<= mouse_x<=1080+40 and padHeight-40-284 <= mouse_y <= padHeight-40) :
                draw= False
        if draw:
    ...
    while not crashed:
        ...
        draw_wifi=wifi_func(draw_wifi,mouse_x,mouse_y)
        """
        변화 반복
        """
